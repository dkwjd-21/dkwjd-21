# 👋 안녕하세요, 사용자 경험을 고민하는 개발자 송아정입니다!

> **"복잡한 문제를 단순하게, 기록을 통해 함께 성장하는 개발자를 꿈꿉니다."**

### 📋 About Me
- 💡 **Problem Solving**: 에러 로그 분석과 해결 과정을 Velog에 기록하며, 체계적인 비즈니스 로직과 쿼리 성능 개선을 고민합니다.
- 🎯 **Strategic Planning**: 한정된 자원 속에서 MVP 우선순위를 명확히 설정하고, 선택과 집중을 통해 프로젝트 목표를 달성합니다.
- 🤝 **Communication Leader**: 팀 내 스크럼과 코드 리뷰 문화를 주도하며, 기획부터 개발까지 원활한 소통을 이끌어냅니다.
- 🏃 **Adaptability**: 글로벌미디어학부의 융합 기술 역량과 다양한 실무 경험을 바탕으로 새로운 환경에 빠르게 적응합니다.
- ✍️ **Blog**: [yurisekai.velog](https://velog.io/@yurisekai/posts) 학습 내용 및 에러 해결 과정 기록

### 🎓 Education & Experience
- 🏫 **Soongsil University** - Global Media (Present)
...
**Frontend & Design**
<img src="https://img.shields.io/badge/react-%2320232a.svg?style=for-the-badge&logo=react&logoColor=%2361DAFB" /> <img src="https://img.shields.io/badge/figma-%23F24E1E.svg?style=for-the-badge&logo=figma&logoColor=white" /> 
...
---
📫 **Contact**: dkwjd4774@naver.com / `dkwjd-21` GitHub Issue / [Velog](https://velog.io/@yurisekai/posts)
